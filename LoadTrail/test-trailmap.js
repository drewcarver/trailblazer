...
document.addEventListener('DOMContentLoaded', function () {
    ...
    startPointSelect.addEventListener('change', e => {
        ...
        addMileMarker(selectedOption.dataset.mile)
        startPoint = [selectedOption.dataset.lon, selectedOption.dataset.lat];
    ...
    endPointSelect.addEventListener('change', e => {
        ...
        console.log(selectedOption.dataset.mile)
        addMileMarker(selectedOption.dataset.mile)
        endPoint = [selectedOption.dataset.lon, selectedOption.dataset.lat];
